...
const metadataArray = Schema.Array(Schema.suspend((): Schema.Schema<MetadataValue> => MetadataValue))
const metadataRecord = Schema.Record({
  key: Schema.String,
  value: Schema.suspend((): Schema.Schema<MetadataValue> => MetadataValue)
})
...
const metadataValue = Schema.Union(
  ...
  Schema.Boolean,
  Schema.Null,
  Schema.suspend((): Schema.Schema<MetadataArray> => metadataArray),
  Schema.suspend((): Schema.Schema<MetadataRecord> => metadataRecord)
