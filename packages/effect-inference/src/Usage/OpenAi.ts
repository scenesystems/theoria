...
const OpenAiUsageObservation = Schema.transform(
...
const decodeUsageObservation = Schema.decodeSync(OpenAiUsageObservation)
 ...
 *   const observed = Usage.observeOpenAi(client, (usage) => Effect.log(usage))
