...
const GoogleUsageObservation = Schema.transform(
...
const decodeUsageObservation = Schema.decodeSync(GoogleUsageObservation)
 ...
 *   const observed = Usage.observeGoogle(
 *     client,
