...
).annotations({ identifier: "GeneratedFixture" })
...
).annotations({ identifier: "ReferenceBatch" })
...
class ReferenceEvaluationError extends Schema.TaggedError<ReferenceEvaluationError>()("ReferenceEvaluationError", {
  family: Schema.String,
