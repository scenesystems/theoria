/**
 * Finds one-dimensional roots by bisection and minima by golden-section search
 * through direct, Schema-validated, and runtime-policy entry points.
 *
...
const program = Effect.gen(function*() {
  ...
  yield* Console.log("bisect(cos, 0, 2):", bisect(Numeric.cos, 0, 2))
