...
import { type Cartesian, divide } from "./arithmetic.js"
 ...
 * @category internal
 */
export const sin = (re: number, im: number): Cartesian =>
  Tuple.make(
 ...
 * @category internal
 */
export const tan = (re: number, im: number): Cartesian => {
 ...
 * @category internal
 */
export const sinh = (re: number, im: number): Cartesian =>
  Tuple.make(
 ...
 * @category internal
 */
export const cosh = (re: number, im: number): Cartesian =>
  Tuple.make(
 ...
 * @category internal
 */
export const tanh = (re: number, im: number): Cartesian => {
