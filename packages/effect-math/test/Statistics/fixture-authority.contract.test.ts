...
import fixtureManifest from "../fixtures/statistics-boundary.fixture-manifest.json" with { type: "json" }
import fixturePayload from "../fixtures/statistics-boundary.fixture.json" with { type: "json" }
...
describe("Statistics fixture authority", () => {
  it.effect("manifest conforms to fixture manifest schema", () =>
    Effect.gen(function*() {
      ...
      expect(EffectString.Equivalence(manifest.fixtures[0].name, "statistics-mean-stable")).toStrictEqual(true)
    }))

  it("fixture replay proves canonical mean behavior", () => {
