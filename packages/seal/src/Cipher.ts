 ...
 * Diagnostics never contain key bytes. The published tag and fields are preserved.
 *
 * @since 0.3.0
 * @category errors
 */
export class InvalidKey extends Schema.TaggedError<InvalidKey>("@scenesystems/seal/Cipher/InvalidKey")(
  "InvalidKey",
  {
 ...
 * The published tag and fields are preserved. Applications should handle all such failures alike.
 *
 * @since 0.3.0
 * @category errors
 */
export class DecryptionFailed extends Schema.TaggedError<DecryptionFailed>(
  "@scenesystems/seal/Cipher/DecryptionFailed"
)("DecryptionFailed", { algorithm: Algorithm, reason: Schema.String }) {}
