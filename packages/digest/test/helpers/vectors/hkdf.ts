...
export const hkdfSha256Vectors = {
  ...
  case1: {
    ...
    info: Uint8Array.from({ length: 10 }, (_, i) => Num.sum(0xf0, i)),
    length: 42,
  ...
  case2: {
    ...
    salt: Option.some(Uint8Array.from({ length: 80 }, (_, i) => Num.sum(0x60, i))),
    info: Uint8Array.from({ length: 80 }, (_, i) => Num.sum(0xb0, i)),
    length: 82,
    okm:
