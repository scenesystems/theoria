/**
 * Fixture schema-check script — validates every committed DSPy fixture JSON
...
import { FixtureManifestSchema, KnownFixtureSchema } from "../test/helpers/dspy-fixtures/schemas.js"

const FIXTURE_ROOT = "test/fixtures/dspy"
      ...
      Effect.gen(function*() {
        ...
        if (stat.type === "Directory") {
          return entry === "invalid"
            ? Arr.empty<string>()
            : yield* findJsonFiles(fs, pathService, root, relative)
        }
