...
} from "../../src/internal/miprov2/runtime/policy.js"
import { trialBudget } from "../../src/MIPROv2Search.js"
import {
  loadFixture,
...
describe("MIPROv2 DSPy phase parity", () => {
  ...
  it.effect("matches fixture-defined tip vocabulary and marker template", () =>
    Effect.gen(function*() {
      ...
      expect(defaultTipVocabulary).toEqual(fixture.payload.defaultTips)
