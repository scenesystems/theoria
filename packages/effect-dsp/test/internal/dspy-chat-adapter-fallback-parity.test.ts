...
import { ChatParseFallbackFixtureSchema, loadFixture } from "../helpers/dspy-fixtures/index.js"
...
describe("internal/chat-adapter fallback DSPy parity", () => {
  it.effect("matches fallback eligibility semantics across all contract cases", () =>
    Effect.gen(function*() {
      const rawFixture = yield* loadFixture("dspy.chat.parse-fallback.contract")
