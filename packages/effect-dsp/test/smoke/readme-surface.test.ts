...
describe("package/readme-surface", () => {
  it.effect("documents only the shipped module, optimizer, and public subpath surfaces", () =>
    Effect.gen(function*() {
      ...
      expect(readme).toContain("MockLanguageModel")
      ...
      expect(readme).toContain("imported Amp thread exports")
      ...
      expect(readme).not.toContain("examples/shared/amp-thread-strategy-study.ts")
