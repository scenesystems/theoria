...
import * as Events from "./StudyEvent.js"
import * as Snapshots from "./StudySnapshot.js"
...
const envelopePayload = Schema.Union(
  ...
  Schema.TaggedStruct("StudySnapshot", { snapshot: Snapshots.StudySnapshot }),
  Schema.TaggedStruct("StudyEvent", { event: Events.StudyEvent }),
