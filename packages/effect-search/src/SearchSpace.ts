...
import { Choice, type Choice as ChoiceValue, Distribution } from "./Distribution.js"
import * as Activity from "./internal/searchSpace/activity.js"
import * as Compile from "./internal/searchSpace/compile/public.js"
...
type BranchCaseType<
  ...
  BranchValue extends ChoiceValue
...
export class Case<
  ...
  Value extends ChoiceValue = ChoiceValue
...
export const categorical = <const Choices extends Iterable<ChoiceValue>>(
  choices: Choices
...
export const when = <BranchValue extends ChoiceValue, SpaceSchema extends Schema.Schema.AnyNoContext>(
  value: BranchValue,
