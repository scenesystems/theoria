...
export {
  /** @since 0.1.0 */ ContinueHeartbeat,
  /** @since 0.1.0 */ ContinuePruneDecision,
  ...
  /** @since 0.1.0 */ isPruneDecision,
  /** @since 0.1.0 */ matchHeartbeatDecision,
  /** @since 0.1.0 */ matchPruneDecision,
