...
export const isNumericCompletedTrial = (
  trial: Trial.Trial<unknown>
): trial is Trial.NumericCompletedTrial<unknown> => isCompletedTrial(trial) && Trial.isNumericCompleted(trial)
...
export const isNumericCompletedTrialWithConfig = <Config>(
  trial: Trial.Trial<Config>
): trial is Trial.NumericCompletedTrial<Config> => isCompletedTrialWithConfig(trial) && Trial.isNumericCompleted(trial)
