...
import { type ArtifactStorageError, type SearchError, TrialError } from "../../SearchError.js"
import type * as SearchSpace from "../../SearchSpace.js"
import { AskedTrial, Study } from "../../Study.js"
...
import { HandleRuntime, stateOf } from "./askTellState.js"
import { appendEvent, EventPublisher } from "./events.js"
import type { OptimizeOptionsFromSpace } from "./options/input.js"
...
import { initializeRuntime, setRuntimeLifecycle } from "./runtime/runtimeState.js"
...
): Effect.Effect<Study<Space>, SearchError, Scope.Scope> =>
  Effect.gen(function*() {
    ...
    const eventQueue = yield* Mailbox.make<StudyEvent.Event>()
