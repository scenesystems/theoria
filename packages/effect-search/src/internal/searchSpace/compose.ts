...
import type { SearchSpace as SearchSpaceType } from "../../SearchSpace.js"
...
export const pick = Effect.fn("effect-search/SearchSpace.pick")(
  (space: SearchSpaceType, namesInput: Iterable<string>): Effect.Effect<SearchSpaceType, InvalidSearchSpace> => {
