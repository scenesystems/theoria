/**
 * Validated optimization plan records and resolved runtime settings.
 *
 * @since 0.1.0
 */
...
/**
 * Preserves structurally validated fresh optimization options for later default
...
> extends Data.Class<{
  ...
  readonly objective: Optimization.Objective<Config>
...
export class ResumePlan<
  ...
  Space extends SearchSpace.SearchSpace = SearchSpace.SearchSpace
> extends Data.Class<{
  /** Compiled space checked against the recovered optimization metadata. */
  readonly space: Space
