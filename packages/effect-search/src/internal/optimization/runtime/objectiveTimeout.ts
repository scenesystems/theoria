/**
 * Timeout wrapper for optimization objective evaluation with cancellation support.
 *
 * @since 0.1.0
 */
 ...
 * while anything else in it is kept as `Some` so the optimization sees it. The runtime
