/**
 * Aggregates optimization evaluations and validates objective results.
 *
 * @since 0.1.0
 */
import { Array as Arr, Boolean as Bool, Effect, Match, Number as Num, Option, Schema } from "effect"

import { Value, Vector } from "../../../../Objective.js"
import { ObjectiveReport, ObjectiveResult } from "../../../../Optimization.js"
import { InvalidObjectiveReport, type TrialError } from "../../../../SearchError.js"
import { ObjectiveEvaluation } from "../../objectiveEvaluation.js"
import { objectiveFailure } from "../objective.js"
import { ObjectiveAttempt, ObjectiveSample } from "./outcome.js"
...
const isObjectiveReport = (input: unknown): input is ObjectiveReport => Schema.is(ObjectiveReport)(input)
  ...
  Schema.decodeUnknown(ObjectiveResult)(result).pipe(
    ...
    Effect.flatMap((decoded) =>
      Match.value(decoded).pipe(
        ...
        Match.when(Schema.is(Value), (value) => Effect.succeed(new ObjectiveEvaluation({ value }))),
        Match.exhaustive
      )
    )
  )
