/**
 * Seed and outcome records exchanged with the optimization execution service.
 *
 * @since 0.1.0
 */
...
export class ExecuteOutcome<Config = unknown> extends Data.Class<{
  ...
  readonly completed: Iterable<Trial.CompletedTrial<Config>>
