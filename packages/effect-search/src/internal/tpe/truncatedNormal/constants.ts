...
import { logStrict, PI, sqrt, SQRT_2 } from "effect-math/Numeric"

export const SQRT_TWO = SQRT_2
export const SQRT_TWO_PI = sqrt(2 * PI)
export const LOG_SQRT_TWO_PI = logStrict(SQRT_TWO_PI)
...
export const NDTRI_EXP_APPROX_C = Num.unsafeDivide(sqrt(3), PI)
