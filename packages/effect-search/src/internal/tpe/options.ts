...
import { type AcquisitionImplementation, resolveAcquisition } from "./acquisition.js"
...
export const validateOptions = (
  ...
  Effect.gen(function*() {
    ...
    yield* Effect.when(
      ...
      () => Bool.or(Num.lessThan(noiseAlpha, 0), Num.greaterThan(noiseAlpha, MAX_NOISE_ALPHA))
    )
  })
