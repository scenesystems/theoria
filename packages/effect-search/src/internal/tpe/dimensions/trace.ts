 ...
 * @since 0.1.0
 */
import { type Chunk, Data, Schema, Tuple } from "effect"
 ...
 *
 * @see {@link CandidateRollPair} for the serializable schema
 * @see {@link makeCandidateRollPair} for the constructor
 * @since 0.1.0
 * @category models
 */
export type CandidateRollPair = typeof CandidateRollPair.Type
...
export class DimensionScoreTrace<A> extends Data.Class<{
  readonly candidates: Chunk.Chunk<A>
