 ...
 */
export const valueAt = (valuesInput: Iterable<number>, index: number, fallback: number): number => {
...
export const statsByDimension = (
  vectorsInput: Iterable<Vector>,
  dimensionCount: number
) => {
  const vectors = Arr.fromIterable(vectorsInput)
  return Arr.makeBy(dimensionCount, (dimensionIndex) => {
