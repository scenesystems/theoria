...
const bootstrapReplicates = 8
const maximumBandwidthScale = 5
...
const minimumSpan = (low: number, high: number): number => Num.max(Num.subtract(high, low), noiseFloor)
