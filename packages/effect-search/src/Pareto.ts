...
import { Direction, type Direction as DirectionValue } from "./Direction.js"
...
import { Vector } from "./Objective.js"
...
export const dominates = (
  left: Vector,
  right: Vector,
  directions: Iterable<DirectionValue> = [],
  epsilon = 0
...
/** Ordered objective vector schema. @since 0.7.0 @category schemas */
export { Vector }
