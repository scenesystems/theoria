 ...
 * @category schemas
 */
export const LinearConfig = Schema.Struct({
 ...
 * @category schemas
 */
export const TreeConfig = Schema.Struct({
 ...
 * @category type-level
 */
export type LinearTreeConditionalConfig = Schema.Schema.Type<typeof LinearTreeConditionalConfig>
