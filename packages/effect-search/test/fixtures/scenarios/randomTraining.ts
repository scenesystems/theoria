 ...
 * @category type-level
 */
export type RandomTrainingConfig = Schema.Schema.Type<typeof RandomTrainingConfig>
 ...
 * @category type-level
 */
export type LogLearningRateConfig = Schema.Schema.Type<typeof LogLearningRateConfig>
