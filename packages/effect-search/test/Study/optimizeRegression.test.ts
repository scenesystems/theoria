...
import { Array as Arr, Effect, Either, Number as Num, Option, Schedule } from "effect"
...
const completedValues = (result: Study.SingleObjectiveResult): ReadonlyArray<number> =>
  Arr.flatMap(
