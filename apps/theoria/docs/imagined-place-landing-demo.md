...
- `test/server/imagined-place-route.test.ts`: the route's method, origin, and
  schema checks.
- `e2e/theoria/browser-smoke.spec.ts`: the place builds, a merge moves the
  version counter, and no element overflows the viewport at 320, 390, 820,
  1280, and 1680 px.
- `e2e/theoria/docs.spec.ts`: the landing page's package pills enter the docs
