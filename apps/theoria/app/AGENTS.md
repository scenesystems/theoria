...
| `home/`       | Home page: `HomePage`, `HomeHero`, and the Imagined Place demo (`PlaceActs`, `PlaceArrive`, `PlaceComposition`, `PlaceStage`, `PlaceWalk`, `PlaceMarker`, `PlaceProposals`, `PlaceProposal`, `PlaceArrangement`, `PlaceSearchTrace`, `PlaceStrand`, `PlaceControls`, `PlaceStepCard`, `PlaceHowItsBuilt`; pure projections in `placeViewModel.ts` and `placeSteps.ts`)                                                                                                                                                                                                                                                                                                                                                                                                           |
