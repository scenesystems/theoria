...
export const docsTheme = {
  ...
  navChildLink:
    `group relative flex min-w-0 items-start rounded-lg px-3 py-2 text-ink-600 transition-[background-color,color] hover:bg-stage-0/72 hover:text-ink-900 ${focusEdgeClassName} focus-visible:ring-2 focus-visible:ring-ink-900/20`,
  navChildLinkActive:
  ...
  searchTrigger:
    `flex h-11 min-w-0 items-center gap-2.5 rounded-xl border border-stage-200/90 bg-stage-0/78 px-3 text-ink-600 shadow-chip transition-[border-color,background-color,color] hover:border-stage-300 hover:bg-stage-0/95 hover:text-ink-900 ${focusEdgeClassName} focus-visible:ring-2 focus-visible:ring-ink-900/20`,
  iconButton:
  ...
  searchDialog:
    `w-full max-w-[42rem] overflow-hidden rounded-[1.65rem] border border-stage-300/90 bg-stage-0/98 shadow-hero ring-1 ring-stage-0/70 transition-[opacity,transform] duration-150 data-[starting-style]:translate-y-[-0.5rem] data-[starting-style]:scale-[0.98] data-[starting-style]:opacity-0 data-[ending-style]:translate-y-[-0.5rem] data-[ending-style]:scale-[0.98] data-[ending-style]:opacity-0 ${stillUnderReducedMotion}`,
  drawerBackdrop:
  ...
  drawer:
    `h-full w-[min(22rem,88vw)] translate-x-[var(--drawer-swipe-movement-x)] touch-auto overflow-y-auto overscroll-contain border-r border-stage-300/90 bg-stage-0/98 shadow-hero ${focusEdgeClassName} transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] will-change-transform data-[starting-style]:-translate-x-full data-[ending-style]:-translate-x-full data-[ending-style]:duration-[calc(var(--drawer-swipe-strength)*300ms)] data-[swiping]:select-none ${stillUnderReducedMotion}`,
  code: "overflow-hidden rounded-[1.35rem] border border-stage-200/90 bg-stage-0/92",
  codeAction:
    `inline-flex min-h-10 items-center gap-1.5 rounded-lg bg-transparent px-3 text-ink-600 transition-colors hover:bg-stage-100/70 hover:text-ink-900 ${focusEdgeClassName} focus-visible:ring-2 focus-visible:ring-ink-900/20`
}
