...
export const workflowComparisonProgressViewModel = ({
  ...
  return {
    description: !plan.controls.optimize
    ...
    selectionRows: [
      ["Optimization", workflowComparisonOptimizeLabel(plan.controls.optimize)],
      ["Comparison target", workflowComparisonComparisonModeLabel(plan.controls.comparisonMode)],
