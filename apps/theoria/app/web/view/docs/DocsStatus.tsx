  ...
  <Stack className="gap-12">
    ...
    <Layer className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
      {Arr.map(
        Arr.range(0, 5),
        (index) => (
          <Stack className="min-h-44 gap-5 rounded-2xl border border-hairline/80 bg-paper/72 p-5" key={index}>
...
const GuideSkeleton = () => (
  <Stack className="gap-9">
    <Stack className="gap-5 border-b border-hairline/80 pb-8">
    ...
    <Stack className="gap-4">
      ...
      <PulseLayer className="mt-2 h-52 rounded-2xl border border-hairline-strong/70 bg-ink-strong/90" />
    </Stack>
  </Stack>
)
...
const ApiSkeleton = () => (
  <Stack className="gap-8">
    ...
    {Arr.map(
      Arr.range(0, 2),
      (index) => (
        <Stack className="gap-4 rounded-2xl border border-hairline/80 bg-paper/70 p-5" key={index}>
          <ShimmerLine className="h-6" width="w-1/3" />
          <PulseLayer className="h-24 rounded-xl bg-ink-strong/90" />
          <ShimmerLine width="w-5/6" />
        </Stack>
      )
    )}
