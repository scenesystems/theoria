...
export type WorkflowRenderEvidence = TextContracts.RenderFitnessEvidenceType

export const workflowRenderNormalization = (): ScoreNormalizationPolicy["renderFitness"] => {
  return TextContracts.renderFitnessNormalizationFor(renderFitnessInput)
}

export const renderEvidenceForText = (
  text: string
): Effect.Effect<WorkflowRenderEvidence, unknown, never> => {
