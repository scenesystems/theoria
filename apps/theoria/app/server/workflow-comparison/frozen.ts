...
import { DurableFingerprint, fingerprintOf } from "../../contracts/fingerprint.js"
      ...
      onSome: (comparison) =>
        Effect.all({
          ...
          Effect.map(({ baseline, optimized }) => ({
            consumerId: comparison.publication.consumerId,
            comparisonId: comparison.publication.comparisonId,
