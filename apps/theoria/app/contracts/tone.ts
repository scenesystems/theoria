...
import type { PackageGroup } from "./entry/card.js"
...
export const toneForCard = (id: EntryId): CardTone => Option.getOrElse(HashMap.get(toneByCard, id), () => defaultTone)
