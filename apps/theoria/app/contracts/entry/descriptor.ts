...
export const EntryDescriptor = {
  define: <Entry extends EntryIdType, Input, EncodedInput, Controls, EncodedControls, SeedId extends string>({
    entryId,
    title,
    packageName,
    description,
...
export type EntryDescriptorFingerprintOwner = {
  readonly entryId: EntryIdType
  readonly title: string
  readonly packageName: PackageName
  readonly description: string
  readonly useCase: string
...
const entryDescriptorFingerprintFieldsFor = (descriptor: EntryDescriptorFingerprintOwner) => ({
...
export const entryDescriptorFingerprint = (
  descriptor: EntryDescriptorFingerprintOwner
