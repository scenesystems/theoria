...
describe("Theoria Theme Strategy", () => {
  it.effect("keeps structural surfaces neutral across all cards", () =>
    Effect.gen(function*() {
      ...
      const workflowTheme = surfaceThemeForCard("workflow-comparison")
      ...
      expect(workflowTheme.shell).toContain("border-stage-300/85")
      ...
      expect(workflowTheme.panel).toContain("border-stage-200/95")
      ...
      expect(workflowTheme.statusTag).toContain("border-stage-200/90")
    }))
