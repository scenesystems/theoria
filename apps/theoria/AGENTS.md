...
13. **Canonical native models** — Schema owns validated and encoded data; Data owns structural runtime values; Context owns capabilities. Derive from the owning declaration, with no parallel models, `as` assertions, or `satisfies`.
